...
import com.xuchengpu.bilibili.utils.alipay.PayResult;
import com.xuchengpu.bilibili.utils.alipay.SignUtils;
...
//        List<GoodsBean> goodsBeens = CartStorage.getInstance(mContext).getAllData();
    ...
    public void pay() {
        if (TextUtils.isEmpty(PARTNER) || TextUtils.isEmpty(RSA_PRIVATE) || TextUtils.isEmpty(SELLER)) {
            new AlertDialog.Builder(CartActivity.this).setTitle("警告").setMessage("需要配置PARTNER | RSA_PRIVATE| SELLER")
